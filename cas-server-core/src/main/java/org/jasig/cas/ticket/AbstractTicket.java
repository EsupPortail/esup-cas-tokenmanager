 ...
 */
@MappedSuperclass
public abstract class AbstractTicket implements Ticket, TicketState, TicketInfo {
    ...
    /** The client ip address that created the ticket */
    @Column(name="IP_ADDRESS")
    private String ipAddress;
    
    /** The client user agent that created the ticket */
